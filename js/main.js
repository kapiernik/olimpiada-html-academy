...
const modalButton = document.querySelector('.banner__button.button.button--card'),
      modalWindow = document.querySelector('.modal.page__modal'),
      modalClose = document.querySelector('.modal__close');

console.log(modalButton);

modalButton.addEventListener('click', () => {
  modalWindow.classList.remove('modal', 'page__modal');
...
modalClose.addEventListener('click', () => {
  ...
  modalWindow.classList.add('modal', 'page__modal');
